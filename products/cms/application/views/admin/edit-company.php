		...
		<div class="row">
		  <div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
			  ...
			  <div class="x_content">
				<br />
				<form id="logoForm" method="POST" action="<?php echo base_url('index.php/adminvenjos/updateCompany');?>" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">

				  <div class="form-group">
					<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Company Address <span class="required">*</span>
					</label>
					<div class="col-md-7 col-sm-7 col-xs-12">
					  <textarea id="comAdrs" name="comAdrs" class="form-control col-md-7 col-xs-12 txtcls" rows="8"><?php echo @$item[0]->comAdrs;?></textarea>
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-md-7 col-sm-7 col-xs-12">
					  <textarea id="comEmail" name="comEmail" class="form-control col-md-7 col-xs-12" required="required"><?php echo @$item[0]->comEmail;?></textarea>
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-md-7 col-sm-7 col-xs-12">
					  <input type="text" id="comMail" name="comMail" class="form-control col-md-7 col-xs-12" required="required"  value="<?php echo @$item[0]->comMail;?>" />
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-md-7 col-sm-7 col-xs-12">
					  <textarea id="comMobile" name="comMobile" class="form-control col-md-7 col-xs-12"><?php echo @$item[0]->comMobile;?></textarea>
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-md-7 col-sm-7 col-xs-12">
					  <input type="text" id="comFax" name="comFax" class="form-control col-md-7 col-xs-12" value="<?php echo @$item[0]->comFax;?>" />
					</div>
				  </div>
