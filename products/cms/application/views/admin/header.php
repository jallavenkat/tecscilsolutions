...
<html lang="en">
  ...
  <head>
    ...
    <title>Tecscilsolutions | Admin Dashboard</title>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li class="<?php if(@$menu == 'logo' || @$menu == 'company' || @$menu == 'socials'){echo 'active';}?>"><a><i class="fa fa-cubes"></i> Configurations <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu" <?php if(@$menu == 'logo' || @$menu == 'company' || @$menu == 'socials'){echo 'style="display:block;"';}?>>
                      ...
                      <li class="<?php if(@$menu == 'socials'){echo 'current-page';}?>"><a href="<?php echo base_url('adminvenjos/socials');?>">Socials</a></li>
                      <li class="<?php if(@$menu == 'menus'){echo 'current-page';}?>"><a href="<?php echo base_url('adminvenjos/menus');?>">Menus</a></li>
                    </ul>
                  </li>
                  <!--#FFBF00-->
                </ul>
