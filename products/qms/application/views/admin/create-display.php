		...
		<div class="row">
		  <div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
			  ...
			  <div class="x_content">
				<br />
				<form id="logoForm" method="POST" action="<?php echo base_url('index.php/adminvenjos/saveDisplay');?>" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">

				  <div class="form-group">
					<label class="control-label col-md-3 col-sm-3 col-xs-12" for="displayMode">Display Mode<span class="required">*</span>
					</label>
					<div class="col-md-7 col-sm-7 col-xs-12">
					  <input type="text" id="displayMode" name="displayMode" class="form-control col-md-7 col-xs-12" required="required" />
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-md-7 col-sm-7 col-xs-12">
					  <input type="text" id="displayWidth" name="displayWidth" class="form-control col-md-7 col-xs-12 isNumber" required="required" />
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-md-7 col-sm-7 col-xs-12">
					  <input type="text" id="displayHeight" name="displayHeight" class="form-control col-md-7 col-xs-12 isNumber" required="required" />
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-md-7 col-sm-7 col-xs-12">
					  <input type="radio" id="displayDefault" name="displayDefault" value="1" />Yes 
					  <input type="radio" id="displayDefault" name="displayDefault" value="0" checked ="checked" />No 
					</div>
				  </div>
