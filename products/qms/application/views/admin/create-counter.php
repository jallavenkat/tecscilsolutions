		...
		<div class="row">
		  <div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
			  ...
			  <div class="x_content">
				<br />
				<form id="logoForm" method="POST" action="<?php echo base_url('index.php/adminvenjos/saveCounter');?>" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">

				  <div class="form-group">
					<label class="control-label col-md-3 col-sm-3 col-xs-12" for="displayMode">Counter Title<span class="required">*</span>
					</label>
					<div class="col-md-4 col-sm-4 col-xs-12">
					  <input type="text" id="counterName" name="counterName" class="form-control col-md-7 col-xs-12" required="required" />
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-md-4 col-sm-4 col-xs-12">
					  <input type="text" id="counterCode" name="counterCode" class="form-control col-md-7 col-xs-12" required="required" />
					</div>
				  </div>
