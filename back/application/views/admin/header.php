        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo base_url('adminvenjos');?>" class="site_title"><i class="fa fa-paw"></i> <span>Tecscilsolutions</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-cubes"></i> Products <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url('adminvenjos/cmsAdmin');?>">CMS Admin</a></li>
                      <li><a href="<?php echo base_url('adminvenjos/ecomAdmin');?>">E-Commerce Admin</a></li>
                      <li><a href="<?php echo base_url('adminvenjos/queueAdmin');?>">Queue Management Admin</a></li>
                    </ul>
                  </li>
              ...
              <div class="menu_section">
                <h3>TecscilSolutions CMS</h3>
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-edit"></i> CMS <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url('adminvenjos/home');?>">Home</a></li>
                      <li><a href="<?php echo base_url('adminvenjos/portfolio');?>">Portfolios</a></li>
                      <li><a href="<?php echo base_url('adminvenjos/services');?>">Services</a></li>
                      <li><a href="<?php echo base_url('adminvenjos/about');?>">About</a></li>
                      <li><a href="<?php echo base_url('adminvenjos/contact');?>">Contact</a></li>
                    </ul>
                  </li>
                  <li>
					<a href="<?php echo base_url('adminvenjos/seo');?>"><i class="fa fa-windows"></i> SEO Tags</a>
				  </li>
                  <li><a href="<?php echo base_url('adminvenjos/enquiries');?>"><i class="fa fa-group"></i> Enquiries</a></li>
                  <li><a href="<?php echo base_url('adminvenjos/enquiries');?>"><i class="fa fa-user"></i> Clients</a></li>
