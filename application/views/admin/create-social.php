		...
		<div class="row">
		  <div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
			  ...
			  <div class="x_content">
				<br />
				<form id="logoForm" method="POST" action="<?php echo base_url('index.php/adminvenjos/saveSocial');?>" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">

				  <div class="form-group">
					<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Social Network Name 
					</label>
					<div class="col-md-7 col-sm-7 col-xs-12">
					  <input type="text" id="socName" name="socName" class="form-control col-md-7 col-xs-12" required />
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-md-7 col-sm-7 col-xs-12">
					  <input type="file" id="socIcon" name="socIcon" class="form-control col-md-7 col-xs-12" required />
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-md-7 col-sm-7 col-xs-12">
					  <input type="text" id="socURL" name="socURL" class="form-control col-md-7 col-xs-12" required />
					</div>
				  </div>
